...
<div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Edit {{ __($module_name) }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function (gambar) {
                        return `<img src="{{ Storage::url('public/slider/${gambar}') }}" alt="${gambar}" width="40" height="40">`;
                    }                    
                },
                {
                    data: 'nama_slider',
