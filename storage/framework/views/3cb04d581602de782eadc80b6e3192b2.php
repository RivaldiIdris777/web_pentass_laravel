...
<head>
    ...
    <link href="<?php echo e(asset('templates/assets/img/favicon.ico')); ?>" rel="icon">
    <link href="<?php echo e(asset('templates/assets/img/logo_um.png')); ?>" rel="apple-touch-icon">
...
<?php /**PATH /opt/lampp/htdocs/Laravel_Project/Laravel_pentaseni/resources/views/frontend/header.blade.php ENDPATH**/ ?>