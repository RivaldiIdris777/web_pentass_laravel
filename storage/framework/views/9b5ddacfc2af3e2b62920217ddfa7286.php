<div class="nav">
    ...
    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link" href="<?php echo e(route('peserta')); ?>">Peserta</a>
        </nav>
    </div>
</div>
<?php /**PATH /opt/lampp/htdocs/Laravel_Project/Laravel_pentaseni/resources/views/layouts2/navigation.blade.php ENDPATH**/ ?>