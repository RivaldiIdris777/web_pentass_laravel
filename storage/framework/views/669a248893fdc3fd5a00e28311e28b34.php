                    ...
                    <div class="row justify-content-md-between p-2">
                        <div class="col-lg-3 col-md-4 d-md-flex align-items-md-stretch">
                            <div class="count-box py-5">
                                <img src="<?php echo e(asset('templates/assets/img/start.png')); ?>" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-4 d-md-flex align-items-md-stretch">
                            <div class="count-box py-5">
                                <img src="<?php echo e(asset('templates/assets/img/solidarity.png')); ?>" alt="">
                        ...
                        <div class="col-lg-3 col-md-4 d-md-flex align-items-md-stretch">
                            <div class="count-box py-5">
                                <img src="<?php echo e(asset('templates/assets/img/winner.png')); ?>" alt="">
    ...
    <section id="cta" class="cta">
        <div class="container" data-aos="fade-in">
            ...
            <div class="text-center">
                ...
                <a class="cta-btn" href="<?php echo e(route('lomba.opsipendaftaran')); ?>">DAFTAR DISINI</a>
            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="<?php echo e(asset('templates/assets/img/poster.jpeg')); ?>" class="img-fluid" alt="">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="<?php echo e(route('lomba.opsipendaftaran')); ?>" class="btn btn-primary">Daftar Sekarang</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel_Project\Laravel_Project\Laravel_pentaseni\resources\views/pages/user/home/index.blade.php ENDPATH**/ ?>