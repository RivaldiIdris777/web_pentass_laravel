    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <a href="<?php echo e(route('home.depan')); ?>" class="btn btn-warning btn-sm" style="margin-right:20px;"><i class="fa fa-globe"></i> Kunjungi Halaman Depan</a>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <?php echo $__env->make('layouts2.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Laravel_Project/Laravel_pentaseni/resources/views/layouts2/app.blade.php ENDPATH**/ ?>