    ...
    <section id="cta" class="cta">
        <div class="container" data-aos="fade-in">
            ...
            <div class="text-center">
                ...
                <a class="cta-btn" href="<?php echo e(route('lomba.pendaftaran')); ?>">DAFTAR DISINI</a>
            </div>
...
<div class="modal fade hide " tabindex="-1" id="postermodal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="<?php echo e(route('lomba.pendaftaran')); ?>" class="btn btn-primary">Daftar Sekarang</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Laravel_Project/Laravel_pentaseni/resources/views/pages/user/home/index.blade.php ENDPATH**/ ?>