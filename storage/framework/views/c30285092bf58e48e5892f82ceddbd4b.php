                    ...
                    <div class="card" style="background-color:#800000">
                        ...
                        <div class="card-footer text-center">
                            <div class="btn-group w-100">
                                ...
                                <a href="<?php echo e(route('lomba.pendaftaran')); ?>" class="btn btn-success btn-sm">Daftar
                                    Disini</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Laravel_Project/Laravel_pentaseni/resources/views/pages/user/lomba/index.blade.php ENDPATH**/ ?>